...
public class JoinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        duCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                checkDu.setText("사용 가능한 ID입니다.");
                checkDu.setVisibility(View.VISIBLE);
            }
        });
        if (joinPw.getText().toString().equals(joinPw.getText().toString())){
            chechPw.setVisibility(View.VISIBLE);
            join.setEnabled(true);
        }
        else {
            chechPw.setText("비밀번호가 일치하지 않습니다.");
            chechPw.setVisibility(View.VISIBLE);
